...
// Fetches all videos from the backend.
      const res = await axios.get("https://youtube-clone-capstone-project-backend-18.onrender.com/api/videos", {
        headers: {
          Authorization: formattedToken,
        },
      });

      const current = await axios.get(`https://youtube-clone-capstone-project-backend-18.onrender.com/api/videos/${videoId}`, {
        headers: {
          Authorization: formattedToken,
        },
      });
